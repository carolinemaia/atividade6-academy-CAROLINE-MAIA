...
Then("aparecerá mensagem informando que o campo nome é obrigatório", function () {
  cadastroPage.mensagemNome();
});

Then("aparecerá mensagem informando que o campo email é obrigatório", function () {
...
Then("o site emite mensagem Informe no máximo 100 caracteres para o nome", function () { 
     cy.contains("Informe no máximo 100 caracteres para o nome").should(
       "be.visible"
     );
});

Then("o site emite mensagem Informe no máximo 60 caracteres para o e-mail", function () {
  cy.contains("Informe no máximo 60 caracteres para o e-mail").should(
    "be.visible"
  );
});

Then("o site emite mensagem Informe pelo menos 4 letras para o nome.", function () {
  cy.contains("Informe pelo menos 4 letras para o nome.").should(
      "be.visible"
    );
});

Then("o site emite mensagem Informe pelo menos 4 caracteres para o e-mail.", function () {
